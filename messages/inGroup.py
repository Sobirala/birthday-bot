FIRST_ADD = """
Всім привіт! 👋
Я Собірала ДР і ось, що я вмію:
▪ вести календар днів народження та повідомляти про наближення ДР (у особистих повідомленнях);
▪ автоматично створювати чати для обговорення кожного майбутнього ДР, таємно від іменинників;
