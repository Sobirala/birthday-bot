...
REMOVEALL = """
Ваша дата народження та всі персональні дані видалені із Собірап. Тепер ви не отримуватимете повідомлення про майбутні дні народження, а учасники груп не дізнаються про ваше ДН 😿
"""
